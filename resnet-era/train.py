...
group.add_argument('--log-swanlab', action='store_true', default=False,
                   help='log training and validation metrics to swanlab')
group.add_argument('--swanlab-project', default=None, type=str,
                   help='swanlab project name')
group.add_argument('--swanlab-tags', default=[], type=str, nargs='+',
                   help='swanlab tags')
...
group = parser.add_argument_group('ERA Related Args')
group.add_argument('--H_min', type=float, default=0.6,
                  help='Minimum value for H_min')
...
def main():
    ...
    # Add H_min to model kwargs for ERA
    args.model_kwargs["H_min"] = args.H_min
    ...
    if utils.is_primary(args):
        ...
        if args.log_swanlab:
            if has_swanlab:
                ...
                _logger.warning(
                    "You've requested to log metrics to swanlab but package not found. "
                    "Metrics not being logged to swanlab, try `pip install swanlab`")
        ...
        for epoch in range(start_epoch, num_epochs):
            ...
            if output_dir is not None:
                ...
                utils.update_summary(
                    ...
                    log_swanlab=args.log_swanlab and has_swanlab
                )
